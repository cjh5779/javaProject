...
<html>
	...
	<body>
		...
		title2 소문자로 변경 (fn:toLowerCase()) : ${fn:toLowerCase(title1)}<br>
		...
		title2에 중심 포함 여부 확인 (fn:contains()) : ${fn:contains(title1, str1)}<br>
		title2에 '중심'문자열 시작 위치(index) 반환 (fn:indexOf()) : ${fn:indexOf(title2, str1)}<br>
	</body>
</html>