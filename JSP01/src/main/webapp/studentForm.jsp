	...
	<body>
		...
		<form name="frmStudent" method="post"  action="newStudentOk.jsp">
		 ...
		 <!-- 클래스의 필드명과 태그의 name 속성을 동일하게 구성 -->
	       ...
	       <tr><td>관심분야</td>
	       <td>
	       		<input type="checkbox" id="web" name="stdInterest" value="웹 프로그래밍">웹 프로그래밍
	       		<input type="checkbox" id="web" name="stdInterest" value="파이썬">파이썬
	       		<input type="checkbox" id="web" name="stdInterest" value="빅데이터">빅데이터
	       		<input type="checkbox" id="web" name="stdInterest" value="java">java 프로그래밍
	       </td></tr>
