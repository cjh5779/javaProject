...
public class ArrayCopy {
	public static void main(String[] args) {
		...
		// 2. Object.clone() -> Object를 모든 클래스는 상속 받기 때문에 배열 객체에도 object의 clone() 메소드가
		// 있음
		int[] a2 = { 1, 2, 3, 4 };
		int[] b2 = a2.clone();
		
		System.out.println("\nObject.clone()을 이용한 깊은 복사");
		...
		// 3. Arrays
		// Arrays.copyOf(원본배열, 복사할길이) - 새로운 배열 객체 생성 후 반환
		// Arrays.copyOfRange(원본배열, 시작인덱스, 끝인인덱스) - 새로운 배열 객체 생성 후 반환
		int[] a3 = { 1, 2, 3, 4 };
		int[] b3 = Arrays.copyOf(a3, a3.length);
		int[] b3One = Arrays.copyOfRange(a3, 1, 3); // 인덱스 1 ~ 2
		
		System.out.println("\nArrays.copyOf()을 이용한 깊은 복사");
		...
		System.out.println("\nArrays.copyOfRange()을 이용한 깊은 복사");
		...
		// 향상된 for문 : 참조 객체 중 배열 또는 컬렌션의 항목요소를 순차적으로 처리
