...
public class StudentController {
	...
	// URL을 통한 데이터 전달 받기
	@RequestMapping("/student/studentDetailView/{stdNo}") // stdNo pathVariable과
	public String studentDetailView(@PathVariable String stdNo) { // 매개변수 stdNo은 동일해야 함
	...
	// 검색폼에서 전달된 파라미터 값을 받아서 HashMap에 받아서 dao에서 활용하도록 전달
	...
	public String studentSearch(@RequestParam HashMap<String, Object> param, Model model) {
		// param 값 출력 : key로 value 찾아서 출력 -> 파라미터명이 key, 파라미터값이 value
	...
	public String studentDetailView1(@PathVariable String stdNo,
